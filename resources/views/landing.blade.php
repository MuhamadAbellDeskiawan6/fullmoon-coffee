...
<body class="bg-[#F8F8F8] text-gray-800">
    ...
    <section class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-center">
            ...
            <!-- Menu Dummy from Unsplash -->
            @php
            $menus = [
            ['nama' => 'Espresso', 'deskripsi' => 'Espresso strong & smooth.', 'foto' => 'https://images.unsplash.com/photo-1531835207745-506a1bc035d8?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'],
            ['nama' => 'Kopi Gula Aren', 'deskripsi' => 'Latte creamy and light.', 'foto' => 'https://plus.unsplash.com/premium_photo-1723759448747-1d174225e61f?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'],
            ['nama' => 'Spannish Latte', 'deskripsi' => 'Cappuccino rich foam.', 'foto' => 'https://images.unsplash.com/photo-1626595444746-59219e6838ac?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'],
            ];
            @endphp

            @foreach($menus as $menu)
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:scale-105 transform transition w-full max-w-xs mx-auto">
                <img src="{{ $menu['foto'] }}" alt="{{ $menu['nama'] }}" class="w-full h-48 object-cover" />
                <div class="p-4">
    ...
    <section class="bg-white py-16">
        <div class="container mx-auto px-4 text-center max-w-2xl">
            ...
            <div class="flex justify-center space-x-4">
                <a href="https://www.instagram.com/fullmooncoffee.id" target="_blank" class="hover:text-[#BDB5A4] transition">
    ...
    <footer class="bg-[#BDB5A4] text-white py-8 mt-12">
        <div class="text-center text-sm">&copy; 2025 Fullmoon Coffee | IG: @fullmooncoffee.id</div>
    </footer>
